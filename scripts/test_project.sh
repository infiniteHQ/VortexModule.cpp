...
mkdir ../lib/vortex/tests/projects/sampleproject/.vx/modules
cp -r ../dist/* ../lib/vortex/tests/projects/sampleproject/.vx/modules
...
PROJECT_PATH="${SCRIPT_DIR}/../lib/vortex/tests/projects/sampleproject"
